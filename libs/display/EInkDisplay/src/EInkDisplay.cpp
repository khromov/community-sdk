...
// Improved: ABSOLUTE MAXIMUM (40 frames, 10-byte drive pulses, slower rate) for complete transitions
const unsigned char lut_ultrafast_bw[] PROGMEM = {
    ...
    // 00=Hi-Z, 01=VSH1, 10=VSH2(white), 11=VSL(black)

    // L0: No change (both black) - RED=0, BW=0
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,

    // L1: Black→White - RED=0, BW=1 - drive WHITE (VSH2 = 10)
    // ABSOLUTE MAXIMUM: 0xAA x10 = 40 full phases of VSH2
    0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA,

    // L2: White→Black - RED=1, BW=0 - drive BLACK (VSL = 11)
    // ABSOLUTE MAXIMUM: 0xFF x10 = 40 full phases of VSL
    ...
    // TP/RP groups - ALL 10 groups (40 frames total) - ABSOLUTE MAXIMUM
    ...
    0x01, 0x01, 0x01, 0x01, 0x00,  // G3: 4 frames
    0x01, 0x01, 0x01, 0x01, 0x00,  // G4: 4 frames
    0x01, 0x01, 0x01, 0x01, 0x00,  // G5: 4 frames
    0x01, 0x01, 0x01, 0x01, 0x00,  // G6: 4 frames
    0x01, 0x01, 0x01, 0x01, 0x00,  // G7: 4 frames
    0x01, 0x01, 0x01, 0x01, 0x00,  // G8: 4 frames
    0x01, 0x01, 0x01, 0x01, 0x00,  // G9: 4 frames (settle)

    // Frame rate - slower for stronger drive per phase (0xBF→0x9F)
    0x9F, 0x9F, 0x9F, 0x9F, 0x9F,

    // Voltages - VSL adjusted for stronger black (0x32→0x28)
